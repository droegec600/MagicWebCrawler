...
public class DRKTools {
	...
	public static final ImageIcon OK_ICON = new ImageIcon(DRKTools.class.getResource("/images/good.png"));
	public static final ImageIcon FORBIDEN_ICON = new ImageIcon(DRKTools.class.getResource("/images/forbiden.png"));
	public static final ImageIcon BAD_ICON = new ImageIcon(DRKTools.class.getResource("/images/bad.png"));
	public static final ImageIcon UK_ICON = new ImageIcon(DRKTools.class.getResource("/images/uk.png"));
